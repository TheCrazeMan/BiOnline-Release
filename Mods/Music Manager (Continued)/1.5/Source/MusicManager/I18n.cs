...
public static class I18n
{
	...
	{
		List<Season> source = (seasons.NullOrEmpty() ? Utilities.NewAllSeasonsList : seasons);
		return Translate("AllowedSeasons", source.Select(Season).ToCommaList(useAnd: true));
	}
